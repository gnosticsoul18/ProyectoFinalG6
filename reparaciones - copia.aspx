<%@ Page Title="" Language="C#" MasterPageFile="~/Proyecto.Master" AutoEventWireup="true" CodeBehind="reparaciones.aspx.cs" Inherits="Proyecto.reparaciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container text-center">
        <h1>Menú de Reparaciones</h1>
        <asp:GridView ID="ReparacionesGrid" runat="server" HorizontalAlign="Center"
